 ...
 */
DefFactory.prototype.createLiteralDef = function (from, range, actual) {
    "use strict";
    return new Def(from, Def.LITERAL_TYPE, range, actual);
};

// 表明来自于某个函数的参数或某个请求的返回值
DefFactory.prototype.createParameterDef = function (from, range, actual) {
    "use strict";
    return new Def(from, Def.PARAMETER_TYPE, range, actual);
};
/**
