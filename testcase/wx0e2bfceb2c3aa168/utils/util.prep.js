...
module.exports = {
    ...
    objToStr: function (e) {
        var n = '';
        for (var t in e)
            'function' == typeof e[t] || void 0 != e[t] && null != e[t] && (n += t + '=' + e[t] + '&');
        return n;
    },
    ...
    compareTime: function (e, n) {
        ...
        return a.setHours(t[0], 0 == (t[1] + '').indexOf('0') && t[1].length > 1 ? t[1].substring(1) : t[1], 0), i.setHours(o[0], 0 == (o[1] + '').indexOf('0') && o[1].length > 1 ? o[1].substring(1) : o[1], 30), isNaN(a) || isNaN(i) ? null : a > i ? 1 : a < i ? -1 : 0;
    },
    ...
    timeDiff: function (e, n) {
        var t = e - n, o = parseInt(t / 3600000 / 24), a = t - 24 * o * 3600000, i = parseInt(a > 0 ? a / 3600000 : 0), s = a - 3600000 * i;
        return [
            o,
            i,
            parseInt(s > 0 ? s / 60000 : 0)
        ];
    },
    ...
    showToast: function (e) {
        ...
        n.showRemind || (n.showRemind = true, e.setData(e.data), setTimeout(function () {
            e.data.remindBean.showRemind = false, e.setData(e.data);
        }, 2500));
    },
    Remind: function () {
        this.showRemind = false, this.message = '暂无内容';
    },
    cutstr: function (e, n) {
        ...
        for (var i = 0; i < o; i++) {
            var s = e.charAt(i);
            if (t++, escape(s).length > 4 && t++, a = a.concat(s), t >= n)
                return a = a.concat('...');
        }
        return t < n ? e : void 0;
    },
